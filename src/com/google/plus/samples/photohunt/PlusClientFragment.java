...
public final class PlusClientFragment extends Fragment
    ...
    /**
     * Array of strings representing scopes to request for {@link #getArguments()}.
     */
    ...
    private final class PlusClientFragmentHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mPlusClient.isConnected() && activity instanceof OnSignInListener) {
    ...
    public static interface OnSignInListener {
        ...
        /**
         * Called when the {@link PlusClient} fails to connect.
         */
        void onSignInFailed();
    }
    ...
    public static PlusClientFragment getPlusClientFragment(
            FragmentActivity activity, String[] scopes, String[] visibleActivities) {
